...
while(<?=$parameter_name?>_<?=$overload?>_continue)
{
    ...
    {
        convert_to_double_ex(<?=$parameter_name?>_<?=$overload?>_temp);
        <?=$parameter_name?>_<?=$overload?>_array[<?=$parameter_name?>_<?=$overload?>_index] = (<?=$parameter_object->type?>) Z_DVAL_PP(<?=$parameter_name?>_<?=$overload?>_temp);
        <?=$parameter_name?>_<?=$overload?>_index++;
    }
    else
    {
