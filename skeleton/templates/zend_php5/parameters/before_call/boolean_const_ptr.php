...
while(<?=$parameter_name?>_<?=$overload?>_continue)
{
    ...
    {
        convert_to_boolean_ex(<?=$parameter_name?>_<?=$overload?>_temp);
        <?=$parameter_name?>_<?=$overload?>_array[<?=$parameter_name?>_<?=$overload?>_index] = Z_BVAL_PP(<?=$parameter_name?>_<?=$overload?>_temp);
        <?=$parameter_name?>_<?=$overload?>_index++;
    }
    else
    {
